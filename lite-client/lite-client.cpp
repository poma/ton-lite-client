...
bool TestNode::show_help(std::string command) {
  td::TerminalIO::out()
      << "\tList of available commands:\n"
         ...
         "\t\033[32;1;228mlistblocktrans[rev] \033[34;1;228m<block-id-ext> <count> [<start-account-id> <start-trans-lt>]\n"
         "\t                                            \033[37;1;228mLists block transactions, starting immediately after or before the specified one\n"
         "\t\033[32;1;228mbyseqno             \033[34;1;228m<workchain> <shard-prefix> <seqno>\n"
         "\t                                            \033[37;1;228mLooks up a block by workchain, shard and seqno, and shows its header\n"
         "\t\033[32;1;228mbylt                \033[34;1;228m<workchain> <shard-prefix> <lt>\n"
         "\t                                            \033[37;1;228mLooks up a block by workchain, shard and logical time, and shows its header\n"
         "\t\033[32;1;228mbyutime             \033[34;1;228m<workchain> <shard-prefix> <utime>\n"
         "\t                                            \033[37;1;228mLooks up a block by workchain, shard and creation time, and shows its header\n"
